...
export default function CreateListing() {
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      <h1 className="text-3xl text-center mt-6 font-bold">Editar lista</h1>
      <form onSubmit={onSubmit}>
        <p className="text-lg mt-6 font-semibold">Venta / Alquiler</p>
        <div className="flex">
          <button
            type="button"
            id="type"
        ...
        <p className="text-lg mt-6 font-semibold">Amueblada</p>
        <div className="flex">
          <button
            type="button"
            id="furnished"
