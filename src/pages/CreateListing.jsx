...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
    ...
    if (geolocationEnabled) {
      ...
      locationData  = data.status === "ZERO_RESULTS" && undefined;
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      <h1 className="text-3xl text-center mt-6 font-bold">Crear un inmueble</h1>
      <form onSubmit={onSubmit}>
        <p className="text-lg mt-6 font-semibold">Vender / Alquiler</p>
        <div className="flex">
          <button
            type="button"
            id="type"
        ...
        <p className="text-lg mt-6 font-semibold">Nombre</p>
        <input
          type="text"
          id="name"
          value={name}
          onChange={onChange}
          placeholder="Ej: Hermoso lugar en caribe"
          maxLength="32"
          minLength="10"
          required
        ...
        <p className="text-lg mt-6 font-semibold">Estacionamiento</p>
        <div className="flex">
          <button
            type="button"
            id="parking"
        ...
        <p className="text-lg mt-6 font-semibold">Amueblado</p>
        <div className="flex">
          <button
            type="button"
            id="furnished"
        ...
        <textarea
          ...
          value={address}
          onChange={onChange}
          placeholder="Ej: av.rivadavia 2022"
          required
          className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6"
        />
        {!geolocationEnabled && (
        ...
        {offer && (
          <div className="flex items-center mb-6">
            <div className="">
              <p className="text-lg font-semibold">Precio de descuento</p>
              <div className="flex w-full justify-center items-center space-x-6">
                <input
                  type="number"
                  id="discountedPrice"
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            La primera foto será de portada. (max 6)
          </p>
          <input
            type="file"
            id="images"
